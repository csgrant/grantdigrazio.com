...
class NewVisitorTest(LiveServerTestCase):
	...
	def test_can_start_a_list_for_one_user(self):
		...
		# (Edith's hobby is tying fly-flishing lures)
		inputbox.send_keys('Buy peacock feathers')


		# When she hits enter, the page updates, and now the page lists
		# "1. Buy peacock featehrs" as an item in a to-do list
		...
		# She enters "Use peacock feathers to make a fly" (Edit is methodical)
		inputbox = self.browser.find_element_by_id('id_new_item')
	...
	def test_multiple_users_can_start_lists_at_different_urls(self):
		...
		#Francis visits the home page. There is so sign of Edith's list
		self.browser.get(self.live_server_url)
		...
		#Satisfied, they both go back to sleepx
